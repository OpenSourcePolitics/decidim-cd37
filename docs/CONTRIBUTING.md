  # How to contribute to Indre-et-Loire

We're really glad you're reading this, you might be interested by the code source of the Indre-et-Loire decidim application.
...
* If you're unable to find an open issue addressing the problem, [open a new one on the current repository](https://github.com/OpenSourcePolitics/decidim-cd37). Be sure to include a **title and clear description**, as much relevant information as possible, and a **code sample** or an **executable test case** demonstrating the expected behavior that is not occurring.
